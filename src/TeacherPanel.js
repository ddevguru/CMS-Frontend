...
function TeacherPanel() {
  ...
  const adminData = {
    user: { name: "Faculty", avatar: "https://via.placeholder.com/100" },
    notifications: [
  ...
  const menuItems = [
    { icon: <FaHome />, name: "Dashboard", route: "/teacher-panel" },
    ...
    <div className={`dashboard ${isDarkMode ? "dark" : ""}`}>
      ...
      <div className={`sidebar ${isSidebarOpen ? "open" : ""}`}>
        <div className="sidebar-header">
          {isSidebarOpen && <h2 className="portal-title">Faculty's Dashboard</h2>}
